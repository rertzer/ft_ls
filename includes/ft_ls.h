...
#define MAX_LONG_LINE 864
#define MAX_SHORT_LINE 280
...
// load format
int	 load_all_format_data(t_strategies*	  strat,
						  t_directory*	  dir,
...
// format data valid
int load_format_data_valid(t_strategies*   strat,
						   t_data*		   data,
						   t_format_sizes* format_sizes,
						   t_format_data*  format_data);

// format data invalid
int load_format_data_invalid(t_strategies*	 strat,
							 t_data*		 data,
							 t_format_sizes* format_sizes,
							 t_format_data*	 format_data);
