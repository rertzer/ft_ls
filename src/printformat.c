...
static unsigned int print_format_mode(char* dest,
                                      t_format_data* format_data,
                                      t_format_sizes* format_sizes,
                                      unsigned int offset);
static unsigned int print_format_links(char* dest,
                                       t_format_data* format_data,
                                       t_format_sizes* format_sizes,
                                       unsigned int offset);
static unsigned int print_format_size_field(char* dest,
                                            t_format_data* format_data,
                                            t_format_sizes* format_sizes,
                                            unsigned int offset);
static unsigned int print_format_size(char* dest,
                                      t_format_data* format_data,
                                      t_format_sizes* format_sizes,
                                      unsigned int offset);
static unsigned int print_format_device(char* dest,
                                        t_format_data* format_data,
                                        t_format_sizes* format_sizes,
                                        unsigned int offset);
static unsigned int print_format_date(char* dest,
                                      t_format_data* format_data,
                                      t_format_sizes* format_sizes,
                                      unsigned int offset);
static unsigned int print_format_long_ending(char* dest,
                                             t_format_data* format_data,
                                             unsigned int offset);
...
int print_all_format_data(t_strategies* strat,
                          t_directory* dir,
                          t_format_sizes* format_sizes,
                          t_format_data* all_format_data) {
  ...
  for (unsigned int i = 0; i < dir->entry_nb; ++i) {
    ...
    offset =
        strat->printformat(strat, &all_format_data[i], format_sizes, buffer);
  }

  return (OK);
}

int print_format_data_short(t_strategies* strat,
                            t_format_data* format_data,
                            t_format_sizes* format_sizes,
                            char* buffer) {
  (void)strat;
...
int print_format_data_long(t_strategies* strat,
                           t_format_data* format_data,
                           t_format_sizes* format_sizes,
                           char* buffer) {
  unsigned int offset = 0;
...
unsigned int print_format_user(char* dest,
                               t_format_data* format_data,
                               t_format_sizes* format_sizes,
                               unsigned int offset) {
...
unsigned int print_format_group(char* dest,
                                t_format_data* format_data,
                                t_format_sizes* format_sizes,
                                unsigned int offset) {
...
unsigned int no_print_format_user(char* dest,
                                  t_format_data* format_data,
                                  t_format_sizes* format_sizes,
                                  unsigned int offset) {
  (void)dest;
...
unsigned int no_print_format_group(char* dest,
                                   t_format_data* format_data,
                                   t_format_sizes* format_sizes,
                                   unsigned int offset) {
  (void)dest;
...
unsigned int print_format_color(char* dest,
                                t_format_data* format_data,
                                unsigned int offset) {
...
unsigned int print_format_name(char* dest,
                               t_format_data* format_data,
                               unsigned int offset) {
...
unsigned int print_format_color_reset(char* dest,
                                      t_format_data* format_data,
                                      unsigned int offset) {
  if (format_data->color == COLOR_TYPE_DEFT)
    return (0);
