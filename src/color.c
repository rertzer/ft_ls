...
const char *get_color_str(e_color_type color) {
  static const char *colors[] = {
      COLOR_DEFT, COLOR_DIRE, COLOR_LINK, COLOR_EXEC, COLOR_ARCH, COLOR_FIFO,
      COLOR_BKLN, COLOR_SOCK, COLOR_IMAG, COLOR_AUDI, COLOR_BLCK, COLOR_CHAR,
      COLOR_SUID, COLOR_SGID, COLOR_CAPA, COLOR_SKDR, COLOR_OWDR, COLOR_SOWD};
